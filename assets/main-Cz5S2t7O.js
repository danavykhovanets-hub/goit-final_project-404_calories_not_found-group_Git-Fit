var ee=Object.defineProperty;var te=(e,t,a)=>t in e?ee(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var _=(e,t,a)=>te(e,typeof t!="symbol"?t+"":t,a);import{i as U,a as ae,S as G}from"./vendor-Ht0x2cLd.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();function re(){const e=document.querySelector("[data-menu]"),t=document.querySelector("[data-menu-open]"),a=document.querySelector("[data-menu-close]"),r=document.querySelectorAll("[data-nav-link]");if(se(r),!e||!t||!a||e.dataset.headerInitialized==="true")return;e.dataset.headerInitialized="true",e.setAttribute("inert","");const s=()=>{e.classList.add("is-open"),e.removeAttribute("aria-hidden"),e.removeAttribute("inert"),t.setAttribute("aria-expanded","true"),document.body.classList.add("menu-open"),a.focus()},n=()=>{e.classList.contains("is-open")&&(e.contains(document.activeElement)&&t.focus(),e.classList.remove("is-open"),e.setAttribute("aria-hidden","true"),e.setAttribute("inert",""),t.setAttribute("aria-expanded","false"),document.body.classList.remove("menu-open"))};t.addEventListener("click",s),a.addEventListener("click",n),e.addEventListener("click",c=>{c.target.closest("a")&&n()}),document.addEventListener("keydown",c=>{c.key==="Escape"&&n()}),window.addEventListener("resize",()=>{window.matchMedia("(min-width: 768px)").matches&&n()})}function se(e){const a=window.location.pathname.includes("favorites")?"favorites":"home";e.forEach(r=>{const s=r.dataset.navLink===a;r.classList.toggle("is-active",s),s?r.setAttribute("aria-current","page"):r.removeAttribute("aria-current")})}re();const u=e=>{U.error({message:e,position:"topRight",backgroundColor:"#ef4040",messageColor:"#fff",icon:""})},k=(e,t={})=>{U.success({message:e,position:"topRight",backgroundColor:"#088b57",messageColor:"#fff",icon:"",...t})},g=ae.create({baseURL:"https://your-energy.b.goit.study/api",headers:{Accept:"application/json"}});async function ne(){const{data:e}=await g.get("/quote");return e}class V{constructor(t,a=localStorage){_(this,"load",t=>{try{const a=this.storage.getItem(this.key);return a===null?t:JSON.parse(a)}catch(a){return console.error(`Failed to read data from localStorage by key "${this.key}"`,a),t}});_(this,"save",t=>{try{return this.storage.setItem(this.key,JSON.stringify(t)),!0}catch(a){return console.error(`Failed to save data to localStorage by key "${this.key}"`,a),!1}});_(this,"remove",()=>{try{return this.storage.removeItem(this.key),!0}catch(t){return console.error(`Failed to remove data from localStorage by key "${this.key}"`,t),!1}});this.key=t,this.storage=a}}function E(e){var t,a,r;return{status:(t=e==null?void 0:e.response)==null?void 0:t.status,message:(r=(a=e==null?void 0:e.response)==null?void 0:a.data)==null?void 0:r.message}}const F=new V("quote-of-the-day");async function ie(){try{const e=new Date().toISOString().slice(0,10),t=F.load(null);if((t==null?void 0:t.date)===e&&(t!=null&&t.quote))return t.quote;const a=await ne();return F.save({date:e,quote:a}),a}catch(e){return u(ce(e)),null}}async function oe(){const e=document.querySelector("[data-quote-text]"),t=document.querySelector("[data-quote-author]"),a=document.querySelector("[data-quote-author-link]");if(!e||!t)return;const r=await ie();!(r!=null&&r.quote)||!(r!=null&&r.author)||(e.textContent=r.quote,t.textContent=r.author,a&&(a.href=`https://www.google.com/search?q=${encodeURIComponent(r.author)}`))}function ce(e){const{status:t,message:a}=E(e);switch(t){case 404:return a??"Quote of the day was not found.";case 500:return a??"Server error. Please try again later.";default:return a??"Failed to load the quote of the day."}}const le="favorites",Qe=e=>({_id:e._id,name:e.name,burnedCalories:e.burnedCalories,time:e.time,bodyPart:e.bodyPart,target:e.target}),A=new V(le),p="/goit-advancedjs-finalproject-group_4/assets/icons-DeBis6gG.svg",x=(e="")=>String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;"),de=(e,t)=>{if(t.metaType==="favorite")return`
      <button
        type="button"
  ...
  `},me=5;function j({container:e,page:t,totalPages:a,onPageChange:r}){if(!e)return;const s=Number(t),n=Number(a);if(n<=1){e.innerHTML="",e.classList.add("is-hidden"),e.onclick=null;return}const c=ge(s,n),L=P({direction:"prev",page:s-1,disabled:s===1,label:"Go to previous page"}),w=P({direction:"next",page:s+1,disabled:s===n,label:"Go to next page"}),$=c.map(m=>{if(m==="dots")return'<span class="home-pagination-dots">...</span>';const l=m===s;return`
        <button
          type="button"
  ...
  `}function ge(e,t){if(t<=me)return Array.from({length:t},(n,c)=>c+1);const a=[1],r=Math.max(2,e-1),s=Math.min(t-1,e+1);r>2&&a.push("dots");for(let n=r;n<=s;n+=1)a.push(n);return s<t-1&&a.push("dots"),a.push(t),a}const H=document.getElementById("loader");function Y(){H.classList.add("loader--visible")}function Z(){H.classList.remove("loader--visible")}async function pe(e){const{data:t}=await g.post("/subscription",{email:e});return t}const fe=/^\w+(\.\w+)?@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/;function ve(e,t){return typeof e=="string"?e:e!=null&&e.message?e.message:e!=null&&e.error?e.error:t}function ye(){const e=document.querySelector("[data-subscribe-form]");if(!e||e.dataset.subscriptionInitialized==="true")return;e.dataset.subscriptionInitialized="true";const t=e.elements.email,a=e.querySelector(".subscribe-btn");e.addEventListener("submit",async r=>{r.preventDefault();const s=t.value.trim();if(!fe.test(s)){u("Please enter a valid email address."),t.focus();return}R(a,!0);try{const n=await pe(s);k(ve(n,"Subscription successful."),{maxWidth:"500px"}),e.reset()}catch(n){u(he(n))}finally{R(a,!1)}})}function he(e){const{status:t,message:a}=E(e);switch(t){case 400:return a??"Invalid request. Please check your email.";case 404:return a??"Subscription service was not found.";case 409:return a??"This email is already subscribed.";case 500:return a??"Server error. Please try again later.";default:return a??"Something went wrong. Please try again later."}}function R(e,t){e&&(e.disabled=t,e.textContent=t?"Sending...":"Send")}async function _e(e){const{data:t}=await g.get("/exercises",{params:e});return t}const be="Muscles",xe=1,Ee=12;async function Se({filter:e=be,page:t=xe,limit:a=Ee}={}){const{data:r}=await g.get("/filters",{params:{filter:e,page:t,limit:a}});return r}const Le="Muscles",we={Muscles:"muscles","Body parts":"bodypart",Equipment:"equipment"};let b=Le,C=1,f=null,v="";const o={categoriesContainer:document.querySelector(".categories-by-muscles"),categoriesList:document.querySelector(".categories-by-muscles-list"),exercisesContainer:document.querySelector(".exercises"),exercisesList:document.querySelector(".exercises-list"),paginationContainer:document.querySelector("[data-home-pagination]"),searchForm:document.querySelector(".filters-search-form"),filtersSlash:document.querySelector(".filters-slash"),selectedCategory:document.querySelector(".filters-selected-category")};var O;(O=o.categoriesList)==null||O.addEventListener("click",$e);var I;(I=o.searchForm)==null||I.addEventListener("submit",Ce);async function q({filter:e=b,page:t=C}={}){b=e,C=t,f=null,v="",K(),qe();const a=Fe(),r=await Se({filter:b,page:C,limit:a});o.categoriesList.innerHTML=Ae(r.results),j({container:o.paginationContainer,page:Number(r.page),totalPages:r.totalPages,onPageChange:s=>{q({filter:b,page:s})}})}async function T({page:e=1}={}){if(!f)return;const t=Pe(),a={...f,page:e,limit:t};v&&(a.keyword=v);const r=await _e(a),s=r.results??[];Te(),o.exercisesList.innerHTML=s.length?s.map(n=>ue(n)).join(""):ke(),j({container:o.paginationContainer,page:Number(r.page||e),totalPages:r.totalPages,onPageChange:n=>{T({page:n})}})}function $e(e){const t=e.target.closest(".category-card-wrapper");if(!t)return;const{category:a,filter:r}=t.dataset,s=we[r];!s||!a||(f={[s]:a},v="",K(),Me(a),T({page:1}))}function Ce(e){var a;if(e.preventDefault(),!f)return;const t=(a=o.searchForm)==null?void 0:a.querySelector("input");v=(t==null?void 0:t.value.trim())??"",T({page:1})}function Ae(e){return e.map(({filter:t,name:a,imgURL:r})=>{const s=Q(a);return`
  ...
  `}function qe(){var e,t,a,r,s;(e=o.categoriesContainer)==null||e.classList.remove("is-hidden"),(t=o.exercisesContainer)==null||t.classList.add("is-hidden"),(a=o.searchForm)==null||a.classList.add("is-hidden"),(r=o.filtersSlash)==null||r.classList.add("is-hidden"),(s=o.selectedCategory)==null||s.classList.add("is-hidden"),o.selectedCategory&&(o.selectedCategory.textContent="")}function Te(){var e,t,a,r,s;(e=o.categoriesContainer)==null||e.classList.add("is-hidden"),(t=o.exercisesContainer)==null||t.classList.remove("is-hidden"),(a=o.searchForm)==null||a.classList.remove("is-hidden"),(r=o.filtersSlash)==null||r.classList.remove("is-hidden"),(s=o.selectedCategory)==null||s.classList.remove("is-hidden")}function Me(e){o.selectedCategory&&(o.selectedCategory.textContent=Q(e))}function K(){var t;const e=(t=o.searchForm)==null?void 0:t.querySelector("input");e&&(e.value="")}function Fe(){return window.innerWidth<768?9:12}function Pe(){return 10}function Q(e){return e.split(" ").map(t=>t.charAt(0).toUpperCase()+t.slice(1)).join(" ")}function Re(){const e=document.querySelectorAll(".filters-btn");e.forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.filter;e.forEach(r=>{r.classList.toggle("is-active",r===t)}),q({filter:a,page:1})})})}function Oe(){const e=document.querySelector("[data-scroll-up]");if(!e)return;const t=()=>{e.classList.toggle("is-visible",window.scrollY>300)};e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),t(),window.addEventListener("scroll",t,{passive:!0})}function Ie(){const e=document.querySelector("[data-current-year]");e&&(e.textContent=String(new Date().getFullYear()))}async function De(e,t){try{const{result:a}=await g.patch(`/exercises/${e}/rating`,t);return k("Your rating is added successfully!"),a}catch(a){return u(Ne(a)),null}}function Ne(e){const{status:t,message:a}=E(e);switch(t){case 400:return a??"Invalid request. Please check the rating data.";case 404:return a??"Such exercise was not found.";case 409:return a??"This email has already left a rating.";case 500:return a??"Server error. Please try again later.";default:return a??"Failed to add the rating."}}async function Be(e){try{const{data:t}=await g.get(`/exercises/${e}`);return t}catch(t){return u(ze(t)),null}}function ze(e){const{status:t,message:a}=E(e);switch(t){case 400:return a??"Invalid request. Please check the exercise id.";case 404:return a??"Exercise was not found.";case 500:return a??"Server error. Please try again later.";default:return a??"Failed to load the exercise."}}const i={modalExerciceOpenElem:document.querySelector("[data-exercice-modal-open]"),modalRatingOpenElem:null,modalAddToFavoritesElem:null,modalCloseBtn:document.querySelector("[data-modal-close]"),overlay:document.querySelector(".overlay"),modalContainer:document.querySelector(".modal"),modalContent:document.querySelector(".modal_content"),starRatingSelect:null};let y=null,d=null;const Ue=(e,t)=>{const{name:a,gifUrl:r,rating:s,target:n,bodyPart:c,equipment:L,popularity:w,burnedCalories:$,description:m}=e,l=Math.round(s);return`<div class="modal_exercice">
    ...
    <div class="modal_exercice_data_container">
  ...
  </div>`},Ge=()=>`<form class="modal_rating">
      ...
      </form>`,h=async e=>{try{let t;if(Y(),e){const n=e.target.closest(".start-btn");if(!n)return;const c=n.dataset;if(t=c.exerciseId,c.modalType!=="exercice"||!t)return}let a;d||(d=await Be(t));const r=A.load([]),s=J(d,r);a=Ue(d,s),i.modalContent.innerHTML=a,i.overlay.hidden=!1,i.modalContainer.classList.remove("modal-small"),i.modalContainer.classList.add("modal-large"),y="exercice",requestAnimationFrame(()=>{new G(".star-rating",{clearable:!1,maxStars:5}).rebuild()}),i.modalRatingOpenElem=document.querySelector("[data-rating-modal-open]"),i.modalRatingOpenElem.addEventListener("click",W),i.modalAddToFavoritesElem=document.querySelector("[data-favorite]"),i.modalAddToFavoritesElem.addEventListener("click",X)}catch(t){u(t)}finally{Z()}},W=()=>{i.overlay.hidden=!1,i.modalContainer.classList.remove("modal-large"),i.modalContainer.classList.add("modal-small"),y="rating";const e=Ge();i.modalContent.innerHTML=e,requestAnimationFrame(()=>{new G(".star-rating-active",{clearable:!1,maxStars:5}).rebuild()}),i.modalRatingOpenElem.removeEventListener("click",W),i.modalAddToFavoritesElem.removeEventListener("click",X),i.starRatingSelect=document.querySelector(".star-rating-active"),i.starRatingSelect.addEventListener("change",S)},M=()=>{if(y==="rating"){i.starRatingSelect.removeEventListener("change",S),h();return}i.overlay.hidden=!0,d=null},Ve=e=>{if(e.target===i.overlay){if(y==="rating"){i.starRatingSelect.removeEventListener("change",S),h();return}M()}},je=e=>{if(e.key==="Escape"){if(y==="rating"){i.starRatingSelect.removeEventListener("change",S),h();return}M()}},J=(e,t)=>t.some(a=>a._id===e._id),X=e=>{if(!d)return;const t=A.load([]);if(J(d,t)){u("This exercise is already added to favorites.");return}A.save([d,...t]),k("Successfully added to favorites!"),e.target.childNodes[0].textContent="Favorite",e.target.childNodes[1].classList.remove("favorites_icon_empty"),e.target.childNodes[1].classList.add("favorites_icon_fill")},S=e=>{const t=e.target.value,a=i.modalContent.querySelector(".modal_rating_star_rating_number");t&&(a.textContent=`${t}.0`)},He=async e=>{try{e.preventDefault(),Y(),d||u("Excercice is not found. Please, try one more time.");const t=new FormData(e.target),a={rate:Number(t.get("rate")),email:t.get("email"),review:t.get("review")};if(Object.values(a).some(r=>!r)){u("Please make sure that you had filled in all the values.");return}await De(d._id,a),h()}catch(t){u(t)}finally{Z()}};var D;(D=i.modalExerciceOpenElem)==null||D.addEventListener("click",h);var N;(N=i.modalCloseBtn)==null||N.addEventListener("click",M);var B;(B=i.overlay)==null||B.addEventListener("click",Ve);var z;(z=i.modalContent)==null||z.addEventListener("submit",He);document.addEventListener("keydown",je);Re();q();ye();oe();Oe();Ie();export{ue as a,Qe as c,A as f,ie as g,Z as h,ye as i,j as r,Y as s};
//# sourceMappingURL=main-Cz5S2t7O.js.map
